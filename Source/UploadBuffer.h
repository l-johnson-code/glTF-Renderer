...
class UploadBuffer {
    ...
    void Create(ID3D12Device* device, Gpu::Resources* gpu_resources, size_t capacity, D3D12_COMMAND_QUEUE_PRIORITY command_queue_priority, int max_queued_uploads);
    void Begin();
